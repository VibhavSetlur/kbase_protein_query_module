...
from ...stages.analysis.sequence_analysis import SequenceAnalysisStage
        ...
        if 'physicochemical_properties' in sequence_analysis:
            ...
            <div class="col-md-6">
                ...
                <table class="table">
                    ...
                    <tr><td>Extinction Coefficient (280 nm):</td><td>{props.get('extinction_coefficient_280nm', 0):.2f}</td></tr>
                </table>
            </div>
            """
