    ...
    def run(self, input_data, workspace_client=None):
        ...
        try:
            ...
            if self.family_assigner is None:
                ...
                # Try multiple centroid locations
                possible_paths = [
                    self.centroids_path,
                ...
                for p in possible_paths:
                    try:
                        if p and os.path.exists(p):
                            self.family_assigner.load_family_centroids(p)
                            last_err = None
                            break
            ...
            # Also include lightweight metadata expected by some tests
            return StageResult(
                success=True,
                output_data={'family_assignments': family_assignments, 'family_metadata': {}},
                metadata={
