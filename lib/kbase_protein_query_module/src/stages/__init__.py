...
# Use modular analysis implementations
...
from .analysis_stages import IntegratedAnalysisStage
from .analysis.multi_protein_analysis import MultiProteinAnalysisStage
...
STAGE_REGISTRY = {
    ...
    # Integrated wrapper stage for convenience
    'analysis': IntegratedAnalysisStage,
