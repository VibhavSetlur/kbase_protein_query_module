...
Manages execution of protein analysis workflows with dependency handling.
"""
...
class AnalysisManager:
    ...
    def __init__(self, output_manager=None):
        ...
        self.results = {}
        self.analyses: Dict[str, Any] = {}  # Alias for compatibility
        self._loaded_defaults: set = set()  # Track default analyses for tests
        
        # Validate configuration and load available analyses
    ...
    def _load_analysis_modules(self):
        ...
        for analysis_name, config in enabled_analyses.items():
            try:
                # Get module path and class name from config
                ...
                # Import and instantiate the analysis module
    ...
    def can_run_analysis(self, analysis_name: str, available_data: Dict[str, Any]) -> bool:
        ...
        if not is_analysis_enabled(analysis_name) or analysis_name not in self.analysis_modules:
            return False
