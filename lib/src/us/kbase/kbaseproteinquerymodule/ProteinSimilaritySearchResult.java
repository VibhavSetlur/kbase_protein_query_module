...
public class ProteinSimilaritySearchResult {
    ...
    public ProteinSimilaritySearchResult withInputId(String inputId) {
        this.inputId = inputId;
        return this;
    }
    ...
    public ProteinSimilaritySearchResult withInputType(String inputType) {
        this.inputType = inputType;
        return this;
    }
    ...
    public ProteinSimilaritySearchResult withEmbeddingRef(String embeddingRef) {
        this.embeddingRef = embeddingRef;
        return this;
    }
    ...
    public ProteinSimilaritySearchResult withFamilyId(String familyId) {
        this.familyId = familyId;
        return this;
    }
